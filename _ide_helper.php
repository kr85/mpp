 ...
 * Generated for Laravel 4.2.8 on 2014-08-10.
 *
...
namespace {
    ...
    class Sentry extends \Cartalyst\Sentry\Facades\Laravel\Sentry{
		 ...
		 * @static 
		 */
        public static function authenticate($credentials, $remember = null){
    ...
    class Mailgun extends \Bogardo\Mailgun\Facades\Mailgun{
		 ...
		 * @static 
		 */
        public static function __construct($views){
            \Bogardo\Mailgun\Mailgun::__construct($views);
        }
